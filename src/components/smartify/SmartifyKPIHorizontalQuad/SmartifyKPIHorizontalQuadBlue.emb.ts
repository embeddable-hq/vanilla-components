...
export const meta = {
  name: 'SmartifyKPIHorizontalQuadBlue',
  label: 'Smartify KPI Horizontal Quad Blue',
  defaultWidth: 150,
  defaultHeight: 120,
  ...
  inputs: [
    ...
    },
    {
      ...
      description: 'The first tile for the measure',
      category: 'Chart settings',
    },
    {
      name: 'twoTitle',
      ...
      description: 'The second title for the measure',
      category: 'Chart settings',
    },
    {
      name: 'threeTitle',
      ...
      description: 'The third title for the measure',
      category: 'Chart settings',
    },
    {
      name: 'fourTitle',
      type: 'string',
      label: 'Title Measure Four',
      description: 'The fourth title for the measure',
      category: 'Chart settings',
    },
    {
      name: 'description',
    ...
    },
    {
      ...
      type: 'string',
      label: 'Prefix Four',
      description: 'Prefix of the fourth measure',
      category: 'Chart settings',
    },
    {
      name: 'suffix_four',
      type: 'string',
      label: 'Suffix Four',
      description: 'Suffix of the fourth measure',
      category: 'Chart settings',
    },
    {
      name: 'dps',
...
export default defineComponent(Component, meta, {
  props: (inputs: Inputs<typeof meta>) => {
    ...
    const prevResults =
      ...
      loadData({
        from: inputs.ds,
        measures: [inputs.metric_one, inputs.metric_two, inputs.metric_three, inputs.metric_four],
