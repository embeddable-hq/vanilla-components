...
export default function DownloadButton({ show, data }: { show?: boolean; className?: string }) {
  ...
  function handleClick() {
    ...
    setTimeout(() => {  downloadBlob(csv, 'export.csv', 'text/csv;charset=utf-8;'); }, 500);    
  }
  ...
  return (
    <svg 
      ...
      viewBox="0 0 24 24"
      fill="none">
     <g clip-path="url(#clip0_271_1583)">
